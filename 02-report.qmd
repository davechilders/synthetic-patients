...
- [ingests](https://github.com/davechilders/synthetic-patients/blob/main/synthea-pipeline.R) structured data derived from synthetic EHR records (Synthea)
...
The R script for turning synthetic EHR JSON data into tabular parquet files can be viewed on Github [here](https://github.com/davechilders/synthetic-patients/blob/main/synthea-pipeline.R).
